...
class CoachCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.coachCategories.index', compact('coachCategories'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.coachCategories.create');
    }
    ...
    public function store(StoreCoachCategoryRequest $request)
    {
        ...
        return redirect()->route('frontend.coach-categories.index');
    }
    ...
    public function edit(CoachCategory $coachCategory)
    {
        ...
        return view('frontend.coachCategories.edit', compact('coachCategory'));
    }
    ...
    public function show(CoachCategory $coachCategory)
    {
        ...
        return view('frontend.coachCategories.show', compact('coachCategory'));
    }
