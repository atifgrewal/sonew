...
class SportsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.sports.index', compact('sports'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.sports.create');
    }
    ...
    public function store(StoreSportRequest $request)
    {
        ...
        return redirect()->route('frontend.sports.index');
    }
    ...
    public function edit(Sport $sport)
    {
        ...
        return view('frontend.sports.edit', compact('sport'));
    }
    ...
    public function show(Sport $sport)
    {
        ...
        return view('frontend.sports.show', compact('sport'));
    }
