            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @can('coach_access')
                    <li class="nav-item has-treeview {{ request()->is("admin/coach-categories*") ? "menu-open" : "" }}">
                        ...
                        <ul class="nav nav-treeview">
                            @can('coach_category_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.coach-categories.index") }}" class="nav-link {{ request()->is("admin/coach-categories") || request()->is("admin/coach-categories/*") ? "active" : "" }}">
                                        <i class="fa-fw nav-icon fas fa-cogs">
