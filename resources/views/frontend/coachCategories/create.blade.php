    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.coach-categories.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label for="coach_category">{{ trans('cruds.coachCategory.fields.coach_category') }}</label>
                            <input class="form-control" type="text" name="coach_category" id="coach_category" value="{{ old('coach_category', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="coachtype" id="coachtype" value="{{ old('coachtype', '') }}">
