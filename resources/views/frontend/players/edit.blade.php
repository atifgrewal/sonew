                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.players.update", [$player->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="name_id" id="name_id">
                                @foreach($names as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('name_id') ? old('name_id') : $player->name->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="childparent_id" id="childparent_id">
                                @foreach($childparents as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('childparent_id') ? old('childparent_id') : $player->childparent->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('childparent'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('childparent') }}
                                </div>
                            @endif
                        ...
                        <div class="form-group">
                            ...
                            <div class="needsclick dropzone" id="profilephoto-dropzone">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="dob" id="dob" value="{{ old('dob', $player->dob) }}">
                            @if($errors->has('dob'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('dob') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="adress_line_1" id="adress_line_1" value="{{ old('adress_line_1', $player->adress_line_1) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="address_line_2" id="address_line_2" value="{{ old('address_line_2', $player->address_line_2) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="city" id="city" value="{{ old('city', $player->city) }}">
                            @if($errors->has('city'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('city') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\Player::DISABLE_PARTNER_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="disable_partner_{{ $key }}" name="disable_partner" value="{{ $key }}" {{ old('disable_partner', $player->disable_partner) === (string) $key ? 'checked' : '' }}>
                                    <label for="disable_partner_{{ $key }}">{{ $label }}</label>
                                </div>
                            @endforeach
                            @if($errors->has('disable_partner'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('disable_partner') }}
                                </div>
                            @endif
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="disability_type" id="disability_type" value="{{ old('disability_type', $player->disability_type) }}">
