                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.players.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="adress_line_1" id="adress_line_1" value="{{ old('adress_line_1', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\Player::DISABLE_PARTNER_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="disable_partner_{{ $key }}" name="disable_partner" value="{{ $key }}" {{ old('disable_partner', '') === (string) $key ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="disability_type" id="disability_type" value="{{ old('disability_type', '') }}">
