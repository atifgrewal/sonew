    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.sports-types.update", [$sportsType->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="sports_type">{{ trans('cruds.sportsType.fields.sports_type') }}</label>
                            <input class="form-control" type="text" name="sports_type" id="sports_type" value="{{ old('sports_type', $sportsType->sports_type) }}">
