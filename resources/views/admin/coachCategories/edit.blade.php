...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.coach-categories.update", [$coachCategory->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="coach_category">{{ trans('cruds.coachCategory.fields.coach_category') }}</label>
                <input class="form-control {{ $errors->has('coach_category') ? 'is-invalid' : '' }}" type="text" name="coach_category" id="coach_category" value="{{ old('coach_category', $coachCategory->coach_category) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('coachtype') ? 'is-invalid' : '' }}" type="text" name="coachtype" id="coachtype" value="{{ old('coachtype', $coachCategory->coachtype) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('info') ? 'is-invalid' : '' }}" name="info" id="info">{!! old('info', $coachCategory->info) !!}</textarea>
                @if($errors->has('info'))
