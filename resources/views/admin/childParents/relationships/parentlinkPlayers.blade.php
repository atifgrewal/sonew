    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-parentlinkPlayers">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <th>
                                {{ trans('cruds.player.fields.phoneno') }}
                            </th>
                            <th>
                            ...
                            <th>
                                {{ trans('cruds.player.fields.parentlink') }}
                            </th>
                            <th>
                                &nbsp;
                            </th>
...
@endcan
  ...
  let table = $('.datatable-parentlinkPlayers:not(.ajaxTable)').DataTable({ buttons: dtButtons })
