    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-childparentPlayers">
                    <thead>
                        <tr>
                            <th width="10">
                    ...
                    <tbody>
                        @foreach($players as $key => $player)
                            <tr data-entry-id="{{ $player->id }}">
                                ...
                                <td>
                                    {{ $player->childparent->email ?? '' }}
                                </td>
                                <td>
                                    {{ $player->childparent->phone_number ?? '' }}
                                </td>
                                <td>
...
@endcan
  ...
  let table = $('.datatable-childparentPlayers:not(.ajaxTable)').DataTable({ buttons: dtButtons })
