    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.players.update", [$player->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('dob') ? 'is-invalid' : '' }}" type="text" name="dob" id="dob" value="{{ old('dob', $player->dob) }}">
                @if($errors->has('dob'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('adress_line_1') ? 'is-invalid' : '' }}" type="text" name="adress_line_1" id="adress_line_1" value="{{ old('adress_line_1', $player->adress_line_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('address_line_2') ? 'is-invalid' : '' }}" type="text" name="address_line_2" id="address_line_2" value="{{ old('address_line_2', $player->address_line_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('city') ? 'is-invalid' : '' }}" type="text" name="city" id="city" value="{{ old('city', $player->city) }}">
                @if($errors->has('city'))
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Player::DISABLE_PARTNER_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('disable_partner') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="disable_partner_{{ $key }}" name="disable_partner" value="{{ $key }}" {{ old('disable_partner', $player->disable_partner) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('disability_type') ? 'is-invalid' : '' }}" type="text" name="disability_type" id="disability_type" value="{{ old('disability_type', $player->disability_type) }}">
